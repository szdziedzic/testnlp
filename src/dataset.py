...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        truncated_documnet = document[:truncated_length]
        ...
        assert masked_length + prefix_length + suffix_length == truncated_length

        prefix = truncated_documnet[:prefix_length]
        masked_content = truncated_documnet[prefix_length : prefix_length + masked_length]
        # print(masked_content)
        suffix = truncated_documnet[prefix_length + masked_length :]
